...
4. **Criação de `tasks.md`**:
   ...
   - Cada tarefa deve representar uma unidade de trabalho mensurável (ex: migration, modelo de domínio, método de repositório, rota na API, teste, atualização de doc).
